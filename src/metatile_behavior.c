...
static const u8 sTileBitAttributes[] =
{
    ...
    [MB_ROCK_STAIRS] = TILE_ATTRIBUTES(FALSE, FALSE, TRUE),
    ...
    [MB_CABINET] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_KITCHEN] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_DRESSER] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_SNACKS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    ...
    [MB_POKEMART_SHELF] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    ...
    [MB_SIGNPOST] = TILE_ATTRIBUTES(TRUE, FALSE, FALSE),
    ...
    [MB_CABLE_CLUB_WIRELESS_MONITOR] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_BATTLE_RECORDS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_BERRY_TREE_SOIL] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_FOOD] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_INDIGO_PLATEAU_MARK_DPAD] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_INDIGO_PLATEAU_MARK_2_DPAD] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_BLUEPRINTS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_PAINTING] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_POWER_PLANT_MACHINE] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_TELEPHONE] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_COMPUTER] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_ADVERTISING_POSTER] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_FOOD_SMELLS_TASTY] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_TRASH_BIN] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_CUP] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_BLINKING_LIGHTS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_NEATLY_LINED_UP_TOOLS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_IMPRESSIVE_MACHINE] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    ...
    [MB_VIDEO_GAME] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_BURGLARY] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_TRAINER_TOWER_MONITOR] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_CYCLING_ROAD_PULL_DOWN] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
    [MB_CYCLING_ROAD_PULL_DOWN_GRASS] = TILE_ATTRIBUTES(FALSE, FALSE, FALSE),
};
